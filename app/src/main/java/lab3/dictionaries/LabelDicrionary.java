...
public class LabelDicrionary {
    ...
    public static final Label Outline = new Label("очертания", "очертаний", "очертаниям", "очертания", "очертаниями",
            "очертаниях");
    ...
    public static final Label NameDunno = new Label("Незнайка", "Незнайки", "Незнайке", "Незнайку", "Незнайкой",
            "Незнайке");
    public static final Label NameDonut = new Label("Пончик", "Пончика", "Пончику", "Пончика", "Пончиком", "Пончике");
